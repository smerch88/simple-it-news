...
export const LogOut = ({
  ...
  return (
    <div className="visible fixed inset-0 z-50 flex bg-black/20">
      <div className="absolute right-[calc(50%-600px)] top-[85px] flex flex-col items-center justify-between gap-y-6 bg-white px-10 py-10 text-center md:w-[494px] md:rounded md:px-10">
