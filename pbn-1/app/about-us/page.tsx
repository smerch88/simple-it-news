      ...
      <div className="text-t14 md:text-menuItemsMob xl:text-menuTitleMob xl:font-normal">
        <div className="md:mb-8 md:flex">
          ...
          <div className="mb-12 md:mb-8 xl:w-[48%]">
            ...
            <p>
              ...
              надавати нашим читачам завжди свіжу та об'єктивну інформацію про
              останні досягнення в індустрії ІТ. Наша пристрасть полягає в тому,
              щоб тримати вас кроком із швидкими темпами технологічного розвитку
              та ділитися цим з вами. Ми віримо, що інформація - ключ до
              розуміння та участі у сучасному світі технологій. Якщо ви шукаєте
              актуальні та об'єктивні матеріали про індустрію інформаційних
              технологій, курси it та можливості навчання в галузі
        ...
        <div className="mb-12 md:mb-8">
          ...
          <p>
            ...
            команда об'єднує різноманітні експерті знання, поєднуючи технічну
            глибину з креативністю. Ми віримо, що в силі колективного зусилля та
            різноманіття поглядів криється справжня сила інновацій.
          </p>
        </div>
